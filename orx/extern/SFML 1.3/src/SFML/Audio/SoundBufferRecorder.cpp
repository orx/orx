...
////////////////////////////////////////////////////////////
bool SoundBufferRecorder::ProcessSamples(const Int16* Samples, std::size_t SamplesCount)
{
...
////////////////////////////////////////////////////////////
const SoundBuffer& SoundBufferRecorder::GetBuffer()
{
    // Fill the buffer if it's empty
    if (myBuffer.GetSamplesCount() == 0)
