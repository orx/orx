...
{
  return orxPLUGIN_BODY_CORE_FUNCTION(orxSound_SamplePlay)(_u32Channel, _pstSample);
}
...
{
  return orxPLUGIN_BODY_CORE_FUNCTION(orxSound_ChannelStop)(_u32Channel);
}
...
{
  return orxPLUGIN_BODY_CORE_FUNCTION(orxSound_ChannelPause)(_u32Channel, _bPause);
}
...
{
  return orxPLUGIN_BODY_CORE_FUNCTION(orxSound_ChannelTestFlags)(_u32Channel, _u32FlagsToTest);
}
...
{
  orxPLUGIN_BODY_CORE_FUNCTION(orxSound_ChannelSetFlags)(_u32Channel, _u32FlagsToRemove, _u32FlagsToAdd);
}
...
{
  return orxPLUGIN_BODY_CORE_FUNCTION(orxSound_ChannelSetVolume)(_u32Channel, _u8Volume);
}
