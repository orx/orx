...
extern orxDLLAPI orxVOID                        orxMathSet_Exit();
 ...
 */
extern orxDLLAPI orxVOID orxIntervalFloat_Validate(orxINTERVAL_FLOAT *_pstInterval);

/** Swap two interval content.
 * @param _pstInter1 First interval.
 * @param _pstInter2 Second interval.
 */
extern orxDLLAPI orxVOID orxIntervalFloat_Swap(orxINTERVAL_FLOAT *_pstInter1, orxINTERVAL_FLOAT *_pstInter2);
 ...
 */
extern orxDLLAPI orxVOID orxFASTCALL orxIntervalFloat_Extand(orxINTERVAL_FLOAT *_pstInterval, orxFLOAT _fValue, orxBOOL _bIncluded);
/** @} */
 ...
 */
extern orxDLLAPI orxVOID orxFASTCALL orxIntervalInt32_Extand(orxINTERVAL_INT32 *_pstInterval, orxS32 _i32Value);
 ...
 */
extern orxDLLAPI orxINTERVAL_FLOAT_NODE* orxSetNodeFloat_AllocateNode(orxINTERVAL_FLOAT _stInterval, orxU32 _u32ExtDataType, orxHANDLE _hExtData);
 ...
 */
extern orxDLLAPI orxVOID orxFASTCALL orxSetFloat_Clear(orxSET_FLOAT *_pstSet);

/** Add an interval to a float-based set.
 * @param _pstSet Target set.
 * @param _ptInterv Interval to add.
 */
extern orxDLLAPI orxVOID orxFASTCALL orxSetFloat_Add(orxSET_FLOAT *_pstSet, orxINTERVAL_FLOAT _stInterval);
 
/** Substract an interval from a float-based set.
 * @param _pstSet Target set.
 * @param _stInterv Interval to substract.
 */
extern orxDLLAPI orxVOID orxFASTCALL orxSetFloat_Sub(orxSET_FLOAT *_pstet, orxINTERVAL_FLOAT _stInterval);
 ...
 */
extern orxDLLAPI orxINTERVAL_FLOAT_NODE *orxFASTCALL orxSetFloat_FindValueIntervalNode(orxSET_FLOAT *_pstSet, orxFLOAT _fValue);
 ...
 * @return address of the allocated node.
 */
extern orxDLLAPI orxINTERVAL_INT32_NODE* orxSetNodeInt32_AllocateNode(orxINTERVAL_INT32 _stInterval, orxU32 _u32ExtDataType, orxHANDLE _hExtData);
 ...
 * @param _pstSet Set to clear.
 */
extern orxDLLAPI orxVOID orxFASTCALL orxSetInt32_Clear(orxSET_INT32 *_pstSet);

/** Add an interval to an integer-based set.
 * @param _pstSet Target set.
 * @param _ptInterv Interval to add.
 */
extern orxDLLAPI orxVOID orxFASTCALL orxSetInt32_Add(orxSET_INT32 *_pstSet, orxINTERVAL_INT32 _stInterval);
 
/** Substract an interval from an integer-based set.
 * @param _pstSet Target set.
 * @param _stInterv Interval to substract.
 */
extern orxDLLAPI orxVOID orxFASTCALL orxSetInt32_Sub(orxSET_INT32 *_pstet, orxINTERVAL_INT32 _stInterval);
 ...
 * @return Address of the interval node corresponding to the value param or NULL if not found.
 */
extern orxDLLAPI orxINTERVAL_INT32_NODE *orxFASTCALL orxSetInt32_FindValueIntervalNode(orxSET_INT32 *_pstSet, orxS32 _s32Value);
