...
typedef enum __orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_t
{
  ...
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_SWITCH,
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_CREATE_BITMAP,
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_CREATE_VIDEO_BITMAP,
  ...
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_SET_CLIPPING,
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_CLEAR,
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_BLIT,
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_DRAW_SPRITE,
  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_PRINTF,

  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_NUMBER,

  orxPLUGIN_FUNCTION_BASE_ID_DISPLAY_NONE = 0xFFFFFFFF
