...
typedef enum __orxPLUGIN_FUNCTION_BASE_ID_SOUND_t
{
  ...
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_LOAD_MUSIC_FROM_FILE,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_STOP,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_PAUSE,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_UNPAUSE,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_IS_PLAYING,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_PLAY_SAMPLE,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_RELEASE_SAMPLE,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_SET_VOLUME,
  orxPLUGIN_FUNCTION_BASE_ID_SOUND_PLAY_BKGD_MUSIC_FROM_FILE,
