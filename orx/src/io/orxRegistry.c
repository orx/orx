...
{
  /* Adds module dependencies : no dependancy */
...
orxPLUGIN_ADD_CORE_FUNCTION_ARRAY(REGISTRY, FILL, orxRegistry_Fill)
orxPLUGIN_ADD_CORE_FUNCTION_ARRAY(REGISTRY, FLUSH, orxRegistry_Flush)
...
orxPLUGIN_DEFINE_CORE_FUNCTION(orxRegistry_Fill, orxBOOL);
orxPLUGIN_DEFINE_CORE_FUNCTION(orxRegistry_Flush, orxBOOL);
orxPLUGIN_DEFINE_CORE_FUNCTION(orxRegistry_GetInt32, orxS32, orxCONST orxSTRING, orxS32);
orxPLUGIN_DEFINE_CORE_FUNCTION(orxRegistry_GetString, orxCONST orxSTRING, orxCONST orxSTRING, orxCONST orxSTRING);
