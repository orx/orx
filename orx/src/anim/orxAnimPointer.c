...
orxANIM_POINTER *orxAnimPointer_Create(orxANIM_SET *_pstAnimset)
{
  ...
  if(pstAnimpointer != orxNULL)
  {
    ...
    if(orxStructure_Setup((orxSTRUCTURE *)pstAnimpointer, orxSTRUCTURE_ID_ANIMPOINTER) == orxSTATUS_SUCCESS)
    {
      ...
      pstAnimpointer->u32Time             = timer_game_time_get();
...
/***************************************************************************
 ...
 returns: orxSTATUS_SUCCESS / orxSTATUS_FAILED
 ***************************************************************************/
orxSTATUS orxAnimPointer_Compute(orxANIM_POINTER *_pstAnimpointer, orxU32 _u32Time)
{
  orxHANDLE hNewAnim;
  orxU32 u32DT;
...
/***************************************************************************
 ...
 returns: orxSTATUS_SUCCESS / orxSTATUS_FAILED
 ***************************************************************************/
orxSTATUS orxAnimPointer_UpdateAll(orxU32 _u32Time)
{
  ...
  {
    /* Computes anim */
    eResult = orxAnimPointer_Compute(pstAnimpointer, _u32Time);
  }
 ...
 ***************************************************************************/
orxU32 orxAnimPointer_GetTime(orxANIM_POINTER *_pstAnimpointer)
{
...
orxSTATUS orxAnimPointer_SetAnim(orxANIM_POINTER *_pstAnimpointer, orxHANDLE _hAnimHandle)
{
  ...
  if(orxAnimPointer_TestFlag(_pstAnimpointer, orxANIMPOINTER_KU32_ID_FLAG_ANIMSET) != orxFALSE)
  {
    ...
    if((orxU32)_hAnimHandle < orxAnimSet_GetAnimCounter(_pstAnimpointer->pstAnimset))
    {
      ...
      _pstAnimpointer->u32Time = timer_game_time_get();
...
/***************************************************************************
 ...
 returns: orxSTATUS_SUCCESS / orxSTATUS_FAILED
 ***************************************************************************/
orxSTATUS orxAnimPointer_SetTime(orxANIM_POINTER *_pstAnimpointer, orxU32 _u32Time)
{
  orxSTATUS eResult;
...
orxSTATUS orxAnimPointer_SetFrequency(orxANIM_POINTER *_pstAnimpointer, orxFLOAT _fFrequency)
{
  ...
  /* Computes animpointer */
  eResult = orxAnimPointer_Compute(_pstAnimpointer, timer_game_time_get());
