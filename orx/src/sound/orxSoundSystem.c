...
orxPLUGIN_ADD_CORE_FUNCTION_ARRAY(SOUNDSYSTEM, UNLOAD, orxSoundSystem_Unload)
...
orxPLUGIN_DEFINE_CORE_FUNCTION(orxSoundSystem_LoadSample, orxSOUNDSYSTEM_SOUND *, orxCONST orxSTRING);
orxPLUGIN_DEFINE_CORE_FUNCTION(orxSoundSystem_LoadStream, orxSOUNDSYSTEM_SOUND *, orxCONST orxSTRING);
orxPLUGIN_DEFINE_CORE_FUNCTION(orxSoundSystem_Unload, orxVOID, orxSOUNDSYSTEM_SOUND *);
