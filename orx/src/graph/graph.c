...
static plugin_core_st_function plugin_graph_spst_function[PLUGIN_GRAPH_KU32_FUNCTION_NUMBER] =
{
  ...
  {(plugin_function *) &graph_bitmap_create,            PLUGIN_GRAPH_KU32_ID_BITMAP_CREATE},
  {(plugin_function *) &graph_video_bitmap_create,      PLUGIN_GRAPH_KU32_ID_VIDEO_BITMAP_CREATE},
  {(plugin_function *) &graph_bitmap_delete,            PLUGIN_GRAPH_KU32_ID_BITMAP_DELETE},
