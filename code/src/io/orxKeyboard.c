...
#define orxKEYBOARD_DECLARE_KEY_NAME(KEY)   case orxKEYBOARD_KEY_##KEY: zResult = orxKEYBOARD_KZ_LITERAL_PREFIX#KEY; break
  ...
  switch(_eKey)
  {
    ...
    orxKEYBOARD_DECLARE_KEY_NAME(BACK);
    ...
    orxKEYBOARD_DECLARE_KEY_NAME(LEFT_CONTROL);
    orxKEYBOARD_DECLARE_KEY_NAME(LEFT_SHIFT);
    orxKEYBOARD_DECLARE_KEY_NAME(LEFT_ALT);
    orxKEYBOARD_DECLARE_KEY_NAME(LEFT_SYSTEM);
    orxKEYBOARD_DECLARE_KEY_NAME(RIGHT_CONTROL);
    orxKEYBOARD_DECLARE_KEY_NAME(RIGHT_SHIFT);
    orxKEYBOARD_DECLARE_KEY_NAME(RIGHT_ALT);
    orxKEYBOARD_DECLARE_KEY_NAME(RIGHT_SYSTEM);
    orxKEYBOARD_DECLARE_KEY_NAME(MENU);
    orxKEYBOARD_DECLARE_KEY_NAME(LEFT_BRACKET);
    orxKEYBOARD_DECLARE_KEY_NAME(RIGHT_BRACKET);
