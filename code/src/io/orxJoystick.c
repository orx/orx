...
#define orxJOYSTICK_DECLARE_AXES(ID)      \
  orxJOYSTICK_DECLARE_AXIS_NAME(X_##ID);  \
  orxJOYSTICK_DECLARE_AXIS_NAME(Y_##ID);  \
  orxJOYSTICK_DECLARE_AXIS_NAME(Z_##ID);  \
  orxJOYSTICK_DECLARE_AXIS_NAME(R_##ID);  \
  orxJOYSTICK_DECLARE_AXIS_NAME(U_##ID);  \
  orxJOYSTICK_DECLARE_AXIS_NAME(V_##ID);
