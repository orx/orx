...
#define orxJOYSTICK_DECLARE_AXIS_NAME(AXIS) case orxJOYSTICK_AXIS_##AXIS: zResult = orxJOYSTICK_KZ_LITERAL_PREFIX#AXIS; break
  ...
  switch(_eAxis)
  {
    orxJOYSTICK_DECLARE_AXIS_NAME(X);
    orxJOYSTICK_DECLARE_AXIS_NAME(Y);
    orxJOYSTICK_DECLARE_AXIS_NAME(Z);
    orxJOYSTICK_DECLARE_AXIS_NAME(R);
    orxJOYSTICK_DECLARE_AXIS_NAME(U);
    orxJOYSTICK_DECLARE_AXIS_NAME(V);
    orxJOYSTICK_DECLARE_AXIS_NAME(POV);
