...
static orxINLINE void orxFont_CreateDefaultFont()
{
  ...
  if(orxResource_SetMemoryResource(orxFONT_KZ_DEFAULT_FONT_NAME, sstDefaultFont.s64Size, sstDefaultFont.pu8Data, orxFALSE) != orxSTATUS_FAILURE)
  {
...
void orxFASTCALL orxFont_Exit()
{
  ...
  if(sstFont.u32Flags & orxFONT_KU32_STATIC_FLAG_READY)
  {
    ...
    if(sstFont.pstDefaultFont != orxNULL)
    {
      ...
      orxFont_Delete(sstFont.pstDefaultFont);
      orxTexture_Delete(pstTexture);
      orxResource_SetMemoryResource(orxFONT_KZ_DEFAULT_FONT_NAME, 0, orxNULL, orxFALSE);
    }
