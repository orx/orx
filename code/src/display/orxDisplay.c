...
orxPLUGIN_DEFINE_CORE_FUNCTION(orxDisplay_LoadFont, orxBITMAP *, const orxSTRING, const orxSTRING, const orxVECTOR *, const orxVECTOR *, orxFLOAT, orxBOOL, orxFLOAT *);
...
orxBITMAP *orxFASTCALL orxDisplay_LoadFont(const orxSTRING _zFileName, const orxSTRING _zCharacterList, const orxVECTOR *_pvCharacterSize, const orxVECTOR *_pvCharacterSpacing, orxFLOAT _fCharacterPadding, orxBOOL _bSDF, orxFLOAT *_afCharacterWidthList)
{
  return orxPLUGIN_CORE_FUNCTION_POINTER_NAME(orxDisplay_LoadFont)(_zFileName, _zCharacterList, _pvCharacterSize, _pvCharacterSpacing, _fCharacterPadding, _bSDF, _afCharacterWidthList);
}
