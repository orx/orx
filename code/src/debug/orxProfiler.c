...
orxSTATUS orxFASTCALL orxProfiler_Init()
{
  ...
  if(!(sstProfiler.u32Flags & orxPROFILER_KU32_STATIC_FLAG_READY))
  {
    ...
    /* Gets time stamp */
    sstProfiler.adTimeStampHistory[sstProfiler.u32HistoryIndex] = orxSystem_GetTime();
...
void orxFASTCALL orxProfiler_PushMarker(orxS32 _s32MarkerID)
{
  ...
  if(orxFLAG_GET(sstProfiler.u32Flags, orxPROFILER_KU32_STATIC_FLAG_PAUSED | orxPROFILER_KU32_STATIC_FLAG_ENABLE_OPS) == orxPROFILER_KU32_STATIC_FLAG_ENABLE_OPS)
  {
    ...
    if((s32ID >= 0) && (s32ID < sstProfiler.s32MarkerCounter))
    {
      ...
      pstInfo   = &(sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryIndex][s32ID]);
      ...
      if(!orxFLAG_TEST(pstMarker->u32Flags, orxPROFILER_KU32_FLAG_PUSHED))
      {
        ...
        if(orxFLAG_TEST(pstMarker->u32Flags, orxPROFILER_KU32_FLAG_UNIQUE) && (pstInfo->u32PushCounter != 0) && (pstMarker->s32ParentID != sstProfiler.s32CurrentMarker))
        {
          orxS32 i;
          ...
          for(i = 0; i < sstProfiler.s32MarkerCounter; i++)
          {
            ...
            {
              /* Updates its depth */
              sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryIndex][i].u32Depth--;
            }
          }
        }
        else
        ...
        if(orxFLAG_TEST(pstMarker->u32Flags, orxPROFILER_KU32_FLAG_UNIQUE))
        {
          ...
          pstInfo->u32Depth = ++sstProfiler.u16CurrentMarkerDepth;
        }
        else
        {
          /* Clears push depth */
  ...
  if(orxFLAG_GET(sstProfiler.u32Flags, orxPROFILER_KU32_STATIC_FLAG_PAUSED | orxPROFILER_KU32_STATIC_FLAG_ENABLE_OPS) == orxPROFILER_KU32_STATIC_FLAG_ENABLE_OPS)
  {
    ...
    else
    {
      ...
      if(sstProfiler.s32CurrentMarker >= 0)
      {
        ...
        pstInfo   = &(sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryIndex][sstProfiler.s32CurrentMarker]);
...
void orxFASTCALL orxProfiler_ResetAllMarkers()
{
  ...
  if(!orxFLAG_TEST(sstProfiler.u32Flags, orxPROFILER_KU32_STATIC_FLAG_PAUSED))
  {
    ...
    for(i = 0; i < sstProfiler.s32MarkerCounter; i++)
    {
      ...
      /* Gets its info */
      pstInfo = &(sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryIndex][i]);

      /* Inits it */
      pstInfo->dFirstTimeStamp    = orxDOUBLE_0;
      pstInfo->dCumulatedTime     = orxDOUBLE_0;
      pstInfo->dMaxCumulatedTime  = sstProfiler.aastInfoListHistory[u32PreviousIndex][i].dMaxCumulatedTime;
      pstInfo->u32PushCounter     = 0;
      pstInfo->u32Depth           = 0;

      /* Resets marker */
      sstProfiler.astMarkerList[i].dTimeStamp   = orxDOUBLE_0;
      sstProfiler.astMarkerList[i].s32ParentID  = orxPROFILER_KS32_MARKER_ID_NONE;
      orxFLAG_SET(sstProfiler.astMarkerList[i].u32Flags, orxPROFILER_KU32_FLAG_NONE, orxPROFILER_KU32_FLAG_PUSHED|orxPROFILER_KU32_FLAG_INIT);
    }
...
void orxFASTCALL orxProfiler_ResetAllMaxima()
{
  ...
  if(!orxFLAG_TEST(sstProfiler.u32Flags, orxPROFILER_KU32_STATIC_FLAG_PAUSED))
  {
    ...
    {
      /* Resets its maximum */
      sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryIndex][i].dMaxCumulatedTime = sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryIndex][i].dCumulatedTime;
    }
...
orxDOUBLE orxFASTCALL orxProfiler_GetResetTime()
{
  ...
  /* Updates result */
  dResult = sstProfiler.adTimeStampHistory[(sstProfiler.u32HistoryQueryIndex + 1) % orxPROFILER_KU32_HISTORY_LENGTH] - sstProfiler.adTimeStampHistory[sstProfiler.u32HistoryQueryIndex];
...
orxS32 orxFASTCALL orxProfiler_GetNextSortedMarkerID(orxS32 _s32MarkerID)
{
  ...
  if(_s32MarkerID != orxPROFILER_KS32_MARKER_ID_NONE)
  {
    ...
    dPreviousTime = (s32ID < sstProfiler.s32MarkerCounter) ? sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryQueryIndex][s32ID].dFirstTimeStamp : orxDOUBLE_0;
  }
  else
  {
    /* Gets ID */
  ...
  for(i = 0, dBestTime = orxSystem_GetTime(); i < sstProfiler.s32MarkerCounter; i++)
  {
    ...
    /* Gets its time */
    dTime = sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryQueryIndex][i].dFirstTimeStamp;
...
orxDOUBLE orxFASTCALL orxProfiler_GetMarkerTime(orxS32 _s32MarkerID)
{
  ...
  {
    /* Updates result */
    dResult = sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryQueryIndex][s32ID].dCumulatedTime;
  }
  else
  {
    /* Logs message */
...
orxDOUBLE orxFASTCALL orxProfiler_GetMarkerMaxTime(orxS32 _s32MarkerID)
{
  ...
  {
    /* Updates result */
    dResult = sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryQueryIndex][s32ID].dMaxCumulatedTime;
  }
  else
  {
    /* Logs message */
...
orxU32 orxFASTCALL orxProfiler_GetMarkerPushCounter(orxS32 _s32MarkerID)
{
  ...
  {
    /* Updates result */
    u32Result = sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryQueryIndex][s32ID].u32PushCounter;
  }
  else
  {
    /* Logs message */
...
orxDOUBLE orxFASTCALL orxProfiler_GetUniqueMarkerStartTime(orxS32 _s32MarkerID)
{
  ...
  if((s32ID >= 0) && (s32ID < sstProfiler.s32MarkerCounter))
  {
    ...
    {
      /* Updates result */
      dResult = sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryQueryIndex][s32ID].dFirstTimeStamp;
    }
    else
    {
      /* Logs message */
...
orxU32 orxFASTCALL orxProfiler_GetUniqueMarkerDepth(orxS32 _s32MarkerID)
{
  ...
  if((s32ID >= 0) && (s32ID < sstProfiler.s32MarkerCounter))
  {
    ...
    {
      /* Updates result */
      u32Result = sstProfiler.aastInfoListHistory[sstProfiler.u32HistoryQueryIndex][s32ID].u32Depth;
    }
    else
    {
      /* Logs message */
