  ...
  if(!(sstPhysics.u32Flags & orxPHYSICS_KU32_STATIC_FLAG_READY))
  {
    ...
    if(sstPhysics.poWorld != orxNULL)
    {
      ...
      if(sstPhysics.pstClock != orxNULL)
      {
        ...
        eResult = orxClock_Register(sstPhysics.pstClock, orxPhysics_Update, (orxVOID *)sstPhysics.u32Iterations, orxMODULE_ID_PHYSICS, orxCLOCK_FUNCTION_PRIORITY_LOWER);
