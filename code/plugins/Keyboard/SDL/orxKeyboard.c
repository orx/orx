...
orxSTATIC SDLKey orxFASTCALL orxKeyboard_SDL_GetSDLKey(orxKEYBOARD_KEY _eKey)
{
  ...
  switch(_eKey)
  {
    ...
    case orxKEYBOARD_KEY_LEFT_CONTROL:  {eResult = SDLK_LCTRL; break;}
    case orxKEYBOARD_KEY_LEFT_SHIFT:    {eResult = SDLK_LSHIFT; break;}
    case orxKEYBOARD_KEY_LEFT_ALT:      {eResult = SDLK_LALT; break;}
    case orxKEYBOARD_KEY_LEFT_SYSTEM:   {eResult = SDLK_LSUPER; break;}
    case orxKEYBOARD_KEY_RIGHT_CONTROL: {eResult = SDLK_RCTRL; break;}
    case orxKEYBOARD_KEY_RIGHT_SHIFT:   {eResult = SDLK_RSHIFT; break;}
    case orxKEYBOARD_KEY_RIGHT_ALT:     {eResult = SDLK_RALT; break;}
    case orxKEYBOARD_KEY_RIGHT_SYSTEM:  {eResult = SDLK_RSUPER; break;}
    case orxKEYBOARD_KEY_MENU:          {eResult = SDLK_MENU; break;}
    case orxKEYBOARD_KEY_LEFT_BRACKET:  {eResult = SDLK_LEFTBRACKET; break;}
    case orxKEYBOARD_KEY_RIGHT_BRACKET: {eResult = SDLK_RIGHTBRACKET; break;}
...
orxVOID orxKeyboard_SDL_ClearBuffer()
{
  /* Checks */
  orxASSERT((sstKeyboard.u32Flags & orxKEYBOARD_KU32_STATIC_FLAG_READY) == orxKEYBOARD_KU32_STATIC_FLAG_READY);
