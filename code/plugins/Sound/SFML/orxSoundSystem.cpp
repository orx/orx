...
extern "C" orxSTATUS orxFASTCALL orxSoundSystem_SFML_StartRecording(const orxSTRING _zName, orxBOOL _bWriteToFile, orxU32 _u32SampleRate, orxU32 _u32ChannelNumber)
{
  orxSTATUS eResult = orxSTATUS_FAILURE;
...
extern "C" orxSTATUS orxFASTCALL orxSoundSystem_SFML_StopRecording()
{
  orxSTATUS eResult = orxSTATUS_FAILURE;
...
extern "C" orxBOOL orxFASTCALL orxSoundSystem_SFML_HasRecordingSupport()
{
...
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxSoundSystem_SFML_StartRecording, SOUNDSYSTEM, START_RECORDING);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxSoundSystem_SFML_StopRecording, SOUNDSYSTEM, STOP_RECORDING);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxSoundSystem_SFML_HasRecordingSupport, SOUNDSYSTEM, HAS_RECORDING_SUPPORT);
