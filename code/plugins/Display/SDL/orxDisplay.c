...
orxSTATUS orxFASTCALL orxDisplay_SDL_GetBitmapData(const orxBITMAP *_pstBitmap, orxU8 *_au8Data, orxU32 _u32ByteNumber)
{
  ...
  {
    /* Logs message */
    orxDEBUG_PRINT(orxDEBUG_LEVEL_DISPLAY, "Can't get bitmap's data <0x%X> as the buffer size is %d when it should be %s.", _pstBitmap, _u32ByteNumber, u32BufferSize);
...
orxU32 orxFASTCALL orxDisplay_SDL_GetBitmapID(const orxBITMAP *_pstBitmap)
{
  orxU32 u32Result;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_DrawLine(const orxVECTOR *_pvStart, const orxVECTOR *_pvEnd, orxRGBA _stColor)
{
  orxSTATUS eResult = orxSTATUS_SUCCESS;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_DrawPolyline(const orxVECTOR *_avVertexList, orxU32 _u32VertexNumber, orxRGBA _stColor)
{
  orxSTATUS eResult = orxSTATUS_SUCCESS;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_DrawPolygon(const orxVECTOR *_avVertexList, orxU32 _u32VertexNumber, orxRGBA _stColor, orxBOOL _bFill)
{
  orxSTATUS eResult = orxSTATUS_SUCCESS;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_DrawCircle(const orxVECTOR *_pvCenter, orxFLOAT _fRadius, orxRGBA _stColor, orxBOOL _bFill)
{
  orxSTATUS eResult = orxSTATUS_SUCCESS;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_DrawOBox(const orxOBOX *_pstBox, orxRGBA _stColor, orxBOOL _bFill)
{
  orxSTATUS eResult = orxSTATUS_SUCCESS;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_DrawMesh(const orxBITMAP *_pstBitmap, orxDISPLAY_SMOOTHING _eSmoothing, orxDISPLAY_BLEND_MODE _eBlendMode, orxU32 _u32VertexNumber, const orxDISPLAY_VERTEX *_astVertexList)
{
  orxSTATUS eResult = orxSTATUS_SUCCESS;
...
orxBOOL orxFASTCALL orxDisplay_SDL_HasShaderSupport()
{
  /* Checks */
  orxASSERT((sstDisplay.u32Flags & orxDISPLAY_KU32_STATIC_FLAG_READY) == orxDISPLAY_KU32_STATIC_FLAG_READY);
...
orxS32 orxFASTCALL orxDisplay_SDL_GetParameterID(const orxHANDLE _hShader, const orxSTRING _zParam, orxS32 _s32Index, orxBOOL _bIsTexture)
{
  orxDISPLAY_SHADER  *pstShader;
  orxS32              s32Result;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_SetShaderBitmap(orxHANDLE _hShader, orxS32 _s32ID, const orxBITMAP *_pstValue)
{
  orxDISPLAY_SHADER  *pstShader;
  orxSTATUS           eResult;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_SetShaderFloat(orxHANDLE _hShader, orxS32 _s32ID, orxFLOAT _fValue)
{
  orxSTATUS eResult;
...
orxSTATUS orxFASTCALL orxDisplay_SDL_SetShaderVector(orxHANDLE _hShader, orxS32 _s32ID, const orxVECTOR *_pvValue)
{
  orxSTATUS eResult;
...
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_DrawLine, DISPLAY, DRAW_LINE);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_DrawPolyline, DISPLAY, DRAW_POLYLINE);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_DrawPolygon, DISPLAY, DRAW_POLYGON);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_DrawCircle, DISPLAY, DRAW_CIRCLE);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_DrawOBox, DISPLAY, DRAW_OBOX);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_DrawMesh, DISPLAY, DRAW_MESH);
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_HasShaderSupport, DISPLAY, HAS_SHADER_SUPPORT);
...
orxPLUGIN_USER_CORE_FUNCTION_ADD(orxDisplay_SDL_GetParameterID, DISPLAY, GET_PARAMETER_ID);
