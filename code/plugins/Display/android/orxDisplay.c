  ...
  if(_apstBitmapList[0] != sstDisplay.pstDestinationBitmap)
  {
    ...
    if(_apstBitmapList[0] != orxNULL)
    {
      ...
      else
      {
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, _apstBitmapList[0]->uiTexture, 0);
        glASSERT();
      ...
      || (fOrthoBottom != sstDisplay.fLastOrthoBottom))
      {
        ...
        ? orxDisplay_Android_OrthoProjMatrix(&(sstDisplay.mProjectionMatrix), orxFLOAT_0, fOrthoRight, fOrthoBottom, orxFLOAT_0, -1.0f, 1.0f)
        : orxDisplay_Android_OrthoProjMatrix(&(sstDisplay.mProjectionMatrix), orxFLOAT_0, fOrthoRight, orxFLOAT_0, -fOrthoBottom, -1.0f, 1.0f);
...
orxSTATUS orxFASTCALL orxDisplay_Android_Init()
{
  ...
  if(!(sstDisplay.u32Flags & orxDISPLAY_KU32_STATIC_FLAG_READY))
  {
    ...
    && (sstDisplay.pstShaderBank != orxNULL))
    {
        ...
        "void main()"
        "{"
        "  gl_FragColor = _Color0_ * texture2D(_Texture_, _gl_TexCoord0_);"
        "}";
