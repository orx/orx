...
orxSTATUS orxFASTCALL orxDisplay_iOS_TransformText(const orxSTRING _zString, const orxBITMAP *_pstFont, const orxCHARACTER_MAP *_pstMap, const orxDISPLAY_TRANSFORM *_pstTransform, orxRGBA _stColor, orxDISPLAY_SMOOTHING _eSmoothing, orxDISPLAY_BLEND_MODE _eBlendMode)
{
  ...
  /* Inits matrix */
  orxDisplay_iOS_InitMatrix(&mTransform, _pstTransform, orxNULL);
...
orxSTATUS orxFASTCALL orxDisplay_iOS_TransformBitmap(const orxBITMAP *_pstSrc, const orxDISPLAY_TRANSFORM *_pstTransform, orxRGBA _stColor, orxDISPLAY_SMOOTHING _eSmoothing, orxDISPLAY_BLEND_MODE _eBlendMode)
{
  ...
  else
  {
    ...
    /* Inits matrix */
    orxDisplay_iOS_InitMatrix(&mTransform, _pstTransform, _pstSrc);
...
orxBITMAP *orxFASTCALL orxDisplay_iOS_LoadFont(const orxSTRING _zFileName, const orxSTRING _zCharacterList, const orxVECTOR *_pvCharacterSize, const orxVECTOR *_pvCharacterSpacing, orxFLOAT *_afCharacterWidthList)
{
                ...
                if(stbtt_InitFont(&(pstLoadInfo->stFontInfo), pu8Buffer, 0) != 0)
                {
                  ...
                  if(pstLoadInfo->u32GlyphCount > 0)
                  {
                    ...
                    if(pstLoadInfo->astGlyphList != orxNULL)
                    {
                      ...
                      orxFLOAT        fCurrentWidth, fWidth, fHeight;
                      ...
                      /* Updates ascent */
                      iAscent = orxF2S(orxMath_Ceil(orxS2F(iAscent) * pstLoadInfo->vFontScale.fY));

                      /* For all characters */
                      for(u32CharacterCodePoint = orxString_GetFirstCharacterCodePoint(_zCharacterList, &zRemainder), i = 0, fCurrentWidth = fWidth = orxFLOAT_0, fHeight = pstLoadInfo->vCharacterSize.fY, iOffset = 0;
                      ...
                      {
                        int       iGlyphWidth, iGlyphX0, iGlyphX1, iGlyphY0;
                        orxFLOAT  fAdvance;
                        ...
                        stbtt_GetGlyphBitmapBox(&(pstLoadInfo->stFontInfo), pstLoadInfo->astGlyphList[i].s32Index, pstLoadInfo->vFontScale.fX, pstLoadInfo->vFontScale.fY, (int *)&iGlyphX0, (int *)&iGlyphY0, (int *)&iGlyphX1, NULL);

                        /* Updates glyph values */
                        pstLoadInfo->astGlyphList[i].stGlyph.fX = orxMAX(0, orxS2F(iX0));
                        pstLoadInfo->astGlyphList[i].stGlyph.fY = orxS2F(iAscent + iGlyphY0);
                        ...
                        /* Updates offset */
                        iOffset = orxMIN(iOffset, iAscent + iGlyphY0);
                        ...
                        {
                          fCurrentWidth = pstLoadInfo->astGlyphList[i].stGlyph.fWidth;
