...
static orxINLINE void orxDisplay_GLFW_InitShaderSupport()
{
  /* Can support shader? */
...
orxSTATUS orxFASTCALL orxDisplay_GLFW_SetDestinationBitmap(orxBITMAP *_pstDst)
{
  orxSTATUS eResult = orxSTATUS_SUCCESS;
    ...
    if(eResult != orxSTATUS_FAILURE)
    {
      ...
      && (sstDisplay.pstShaderBank != orxNULL))
      {
        ...
        if(eResult != orxSTATUS_FAILURE)
        {
          ...
          orxDisplay_GLFW_InitShaderSupport();
...
orxSTATUS orxFASTCALL orxDisplay_GLFW_SetShaderBitmap(orxHANDLE _hShader, const orxSTRING _zParam, orxBITMAP *_pstValue)
{
  orxDISPLAY_SHADER  *pstShader;
  orxSTATUS           eResult;
