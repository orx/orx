...
LOCAL_ARM_MODE := arm
LOCAL_STATIC_LIBRARIES := orx WebP-prebuilt LiquidFun-prebuilt OpenAL-prebuilt Tremolo-prebuilt
...
LOCAL_ARM_MODE := arm
LOCAL_STATIC_LIBRARIES := orxd WebP-prebuilt LiquidFun-prebuilt OpenAL-prebuilt Tremolo-prebuilt
...
LOCAL_ARM_MODE := arm
LOCAL_STATIC_LIBRARIES := orxp WebP-prebuilt LiquidFun-prebuilt OpenAL-prebuilt Tremolo-prebuilt
