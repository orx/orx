...
typedef enum __orxPLUGIN_FUNCTION_BASE_ID_PHYSICS_t
{
  ...
  orxPLUGIN_FUNCTION_BASE_ID_PHYSICS_SET_SELF_FLAGS,
  orxPLUGIN_FUNCTION_BASE_ID_PHYSICS_SET_CHECK_MASK,
  orxPLUGIN_FUNCTION_BASE_ID_PHYSICS_GET_SELF_FLAGS,
  orxPLUGIN_FUNCTION_BASE_ID_PHYSICS_GET_CHECK_MASK,
