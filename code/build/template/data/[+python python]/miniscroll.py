...
class Mini:
  ...
  """Called when a new object is spawned from an owned spawner"""

  def on_update(self, dt: float): ...
  """Called each clock update"""

  def on_collide(self, collision: Collision): ...
  """Called on physics collision with another object"""

  def on_separate(self, separation: Separation): ...
  """Called on separation from physics collision with another object"""

  def on_shader_param(self, shader_name: str, param_name: str, param_type: type[float | orx.vector.Vector]) -> float | orx.vector.Vector : ...
  """Called on shader parameter lookups for a shader associated with the object"""
