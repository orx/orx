...
#define orxIMGUI_KZ_CONFIG_FONT_SCALE       "FontScale"
...
static orxSTATUS orxFASTCALL orxImGui_BeginFrame(const orxEVENT *_pstEvent)
{
  ...
  orxFLOAT fFontScale = orxConfig_GetFloat(orxIMGUI_KZ_CONFIG_FONT_SCALE);
  orxConfig_PopSection();
  if(fFontScale > orxFLOAT_0)
  {
    rstIO.FontGlobalScale = fFontScale;
  }
