...
static void *orxNuklear_Malloc(nk_handle, void *, nk_size _sSize)
{
  return orxMemory_Allocate((orxU32)_sSize, orxMEMORY_TYPE_TEMP);
}

static void orxNuklear_Free(nk_handle, void *_pPtr)
{
...
static orxNUKLEAR           sstNuklear        = {};

static void orxNuklear_Paste(nk_handle, struct nk_text_edit *_pstTextEdit)
{
...
static void orxNuklear_Copy(nk_handle, const char *_acText, int len)
{
#ifndef alloca
