...
function initplatforms ()
    if os.is ("windows") and not string.find(string.lower(_ACTION), "vs201") then
        return {}
    elseif os.is ("macosx") and string.find(string.lower(_ACTION), "xcode") then
        return {"Universal"}
