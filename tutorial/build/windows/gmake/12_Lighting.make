...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/12_Lighting
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/12_Lighting.exe
...
ifeq ($(config),profile)
  OBJDIR     = obj/Profile/12_Lighting
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/12_Lighting.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/12_Lighting
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/12_Lighting.exe
  DEFINES   += 
  INCLUDES  += -I../../../include -I../../../../code/include
...
$(OBJDIR)/12_Lighting.o: ../../../src/12_Lighting/12_Lighting.c
	@echo $(notdir $<)
