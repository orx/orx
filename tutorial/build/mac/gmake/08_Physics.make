...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/08_Physics
  TARGETDIR  = ../../../bin
  ...
  LDFLAGS   += -L../../../lib -L../../../bin -L../../../../code/lib/dynamic -m64 -L/usr/lib64 -isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.6 -dead_strip
...
ifeq ($(config),profile64)
  OBJDIR     = obj/x64/Profile/08_Physics
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/08_Physics
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/08_Physics
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/08_Physics
  DEFINES   += -D__orxDEBUG__
  INCLUDES  += -I../../../include -I../../../../code/include
  ...
  CXXFLAGS  += $(CFLAGS) -fno-exceptions
  LDFLAGS   += -L../../../lib -L../../../bin -L../../../../code/lib/dynamic -m32 -L/usr/lib32 -isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.6 -dead_strip
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -lorxd -framework Foundation -framework AppKit
  LDDEPS    += 
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
...
ifeq ($(config),profile32)
  OBJDIR     = obj/x32/Profile/08_Physics
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/08_Physics
  DEFINES   += -D__orxPROFILER__
  INCLUDES  += -I../../../include -I../../../../code/include
