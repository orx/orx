...
ifeq ($(config),profile64)
  OBJDIR     = obj/x64/Profile/06_Sound
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/06_Sound
...
ifeq ($(config),profile32)
  OBJDIR     = obj/x32/Profile/06_Sound
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/06_Sound
  DEFINES   += -D__orxPROFILER__
  INCLUDES  += -I../../../include -I../../../../code/include
