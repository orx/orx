...
ifeq ($(config),debuguniv)
  ...
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -msse2 -ffast-math -g -arch i386 -arch x86_64 -arch ppc -arch ppc64 -mmacosx-version-min=10.6 -gdwarf-2 -Wno-write-strings
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-exceptions
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../../../code/lib/dynamic -L. -arch i386 -arch x86_64 -arch ppc -arch ppc64 -mmacosx-version-min=10.6 -dead_strip
...
ifeq ($(config),profileuniv)
  OBJDIR     = obj/Universal/Profile
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/orxcrypt
  DEFINES   += -D__orxPROFILER__ -D__orxSTATIC__
  INCLUDES  += -I../../../include -I../../../../../code/include
  ALL_CPPFLAGS  += $(CPPFLAGS)  $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -msse2 -ffast-math -g -O2 -arch i386 -arch x86_64 -arch ppc -arch ppc64 -mmacosx-version-min=10.6 -gdwarf-2 -Wno-write-strings
