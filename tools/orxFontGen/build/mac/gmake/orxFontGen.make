...
ifeq ($(config),debuguniv)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../../../code/lib/dynamic -L../../../../../extern/freetype-2.4.1/lib/mac -L. -arch i386 -arch x86_64 -arch ppc -arch ppc64 -mmacosx-version-min=10.6 -dead_strip
